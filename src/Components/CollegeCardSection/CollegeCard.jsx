  ...
  return (
    <>
            ...
            >
              ...
              <div className="card-body">
                ...
                <div className="card-actions justify-end">
                  ...
                  <button className="btn bg-image text-white">Details</button>
                  </Link>
                </div>
              </div>
            </div>
      ...
      <div className="text-center mt-7">
        <Link to="/allColleges">
          <button className="border px-8 py-3 rounded transform transition duration-300 ease-linear hover:scale-110 text-white bg-image border-[#f36b3b]">
            See More
          </button>
        </Link>
      </div>
